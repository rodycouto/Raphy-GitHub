...
exports.run = async (client, message, args) => {
    ...
    const VipEmbed = new Discord.MessageEmbed()
        ...
        .addField(`❓ Como comprovar o pagamento?`, `Simples! Entre no [meu servidor](${LinkServidor}) e fale com o **Rody#1000**, enviando um print do **comprovante** e pronto, você tem seu VIP.`)
