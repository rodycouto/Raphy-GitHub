        ...
        if (author1 !== null && timeout1 - (Date.now() - author1) > 0) {
            ...
            if (['all', 'tudo', 'ALL', 'All', 'Tudo', 'TUDO'].includes(args[0])) {
                ...
                let winembed = new Discord.MessageEmbed()
                    .setColor('GREEN')
                    .setTitle('💰 GANHOU!')
                    .setDescription(`<a:Check:836347816036663309> ${message.author} apostou tudo na roleta e faturou ${winprize}<:NPoints:837666759389347910>NPoints`)
            ...
            let winembed = new Discord.MessageEmbed()
                .setColor('GREEN')
                .setTitle('💰 GANHOU!')
                .setDescription(`<a:Check:836347816036663309> ${message.author} apostou ${args[0]} na roleta e faturou ${winprize}<:NPoints:837666759389347910>NPoints`)
